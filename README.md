...
The original Bluetooth functionality and any control functionality on the neck 
speaker is lost, as the relevant components are removed. The neck speakers power supply is removed. 
The battery and all active electronic components are removed from the neck speaker. The amplifier is positined where the battery was. All functionality of the neck speaker that dependend
on the battery is lost. 
...
*  Carefully lift the left part of of the lower part (D). There is a black glue at several locations, that can be removed carfully. 
...
* Remove the 4 grey plastic covers at the backside of the amplifier. 
* Unbolt the 4 screws at the backside of the amplifier. 
* Lift the backside from the amplifier. You find the amplifier board, the lithion batery and the connector (A). 
* Lift the amplifier out of the plastic casing (B)


`!!Do this at your own risk! If you do this, you will lose all manufacturer warrenty! This may destroy your amplifier! 
The authors of this article are not responsible for any potential damage.`
...
To make room for the amplifier casing part of the neck speaker casing needs to be remomved.
...
| Preparing casing |
|--------|
|![Preparing casing](./img/Panel_measuring.png  "Preparing casing")*Preparing casing. Make room for the amplifer, A) The amplifier board needs to fit. Push the board as far as possible to the front edge of the neck piece (red) arrow. Mark the left and right side. Add .5 cm on each side for the casing. B-D) Mark the area you want to cut out.*|


| Cut casing |
|--------|
|![Cut casing](./img/Panel_cutting.png  "Cut casing")*Make vertical (A) and horizontal (B) cuts into the aluminium. Make sure to remove all cutting residuals (C) and clean the cutting edge (D).*|


* Make vertical (A) and horizontal (B) cuts into the aluminium. Make sure that you do not cut into the metal clasp (C)
...
The lower part of the amplifer (i.e. the one with .... ) will be glued to the 
...
* The the part of the casing marked here with an white X (E) can be discarded
...
* Place the half amplifier casing at the corresponding location
* Place something behind the casing to keep in place 
...
The neckspeaker comes with bluetooth. As the smarting amplifier communicates 
with bluethooh as well, and as two bluetooth connecting to a single devices are 
not possible, the neck speakers bluetooth capabilites are removed.  
Furthermore, we had to remove the battery of the neck speacker to make room for 
the amplifier. To still be able to use the speaker and microphone functionality 
we added a jackplug.

### Making room for the jackplug
The jackplug goes where the neckspeakers micro usb connector was. 
...
* Remove everything but the speakers and the respective cabeling from the neck piece (G).
* View from below (H) and from above (I). Left and right side are not connected. 
* We end with a red/black cable for the spakers and a grey cable for the microphone. 
...
* Prepar the Speaker Cable to connect to the jackplug and solder them like in the following picture:
* Ich weiß nicht mehr wie wir das wieder drangelötet und connected haben. 
...
In combination with a small proprietary printed circuit boad (BCB, shown below), 
...
The connector cables can either be soldered onto the front or the back of PCB board of the amplifier. 
